...
static struct metal_interrupt *cpu_intr, *tmr_intr;
static int tmr_id;
static volatile uint32_t timer_isr_flag;
...
static void timer_isr (int id, void *data) {
...
static void wait_for_timer(struct metal_led *which_led) {
